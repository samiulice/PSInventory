...
func RunServer() error {
	...
	flag.IntVar(&cfg.port, "port", 4321, "API Server port to listen on")
	flag.StringVar(&cfg.env, "env", "development", "Application Environment{development|production}")
	flag.StringVar(&cfg.db.dsn, "dsn", "host=localhost port=5432 dbname=psinventory user=postgres password=psi@2024 sslmode=disable", "DSN")
